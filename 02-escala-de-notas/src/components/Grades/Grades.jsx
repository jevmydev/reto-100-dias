...
export const Grades = () => {
    ...
    return (
        <section>
            <div className="max-w-screen-2xl mx-auto p-4 pt-6 flex items-center justify-between">
                <div className="flex flex-col gap-16 justify-between w-full h-full sm:flex-row">
