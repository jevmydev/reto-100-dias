export const FavIcon = ({ width = "w-11", height = "h-11" }) => {
    return <img className={`${width} ${height} aspect-square rounded object-cover`} src="/favicon.webp" alt="Icono de Chessframe" decoding="async" />;
};

export const UndoIcon = ({ width = "w-9", height = "h-9" }) => {
    return (
        <svg className={`${width} ${height}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
            <path
                fillRule="evenodd"
                clipRule="evenodd"
...
export const RedoIcon = ({ width = "w-9", height = "h-9" }) => {
    return (
        <svg className={`${width} ${height}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
